...
export const features = [
  { title: "AI/ML", description: "Use Artificial Intelligence and Machine Learning to enhance user experiences and automate processes.", icon: f1 },
  {
    title: "Sustainability",
    description: "Emphasizing eco-friendly practices and technologies to reduce environmental impact.",
    icon: f2,
  },
  {
    title: "Blockchain",
    description: "Utilizing blockchain technology to ensure transparency, security, and decentralization in transactions.",
    icon: f3,
  },
];
...
export const headerContent = {
  Features: {
    ...
    title: "Event Tracks",
    description:
      "Explore a variety of tracks designed to challenge your skills and creativity, from coding competitions to innovative hackathons.",
  },
  Stats: {
    tag: "Statistics",
